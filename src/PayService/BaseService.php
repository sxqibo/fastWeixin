...
use Sxqibo\Weixin\Common\Cache;
...
class BaseService
{
    protected $base = 'https://api.mch.weixin.qq.com/v3/smartguide/guides';
    ...
    protected $config = [
        ...
        //step2:企业微信联系人
        'contact_user_account' => '', //公司人员用户账号
        'contact_secret'       => '', //通讯录的 secret
    ...
    public function __construct(array $options = [])
    {
        try {
            ...
            //step1:企业微信
            $this->config['corpid']   = $options['corpid'];
            $this->config['store_id'] = $options['store_id'];

            //step2:企业微信联系人
            $this->config['contact_user_account'] = $options['contact_user_account'];
            $this->config['contact_secret']       = $options['contact_secret'];
